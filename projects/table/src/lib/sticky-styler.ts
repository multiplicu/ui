 ...
 * @docs-private
 */
import { Direction } from '@multiplicu/ui/core';
...
/**
 * Applies and removes sticky positioning styles to the `XcuTable` rows and columns cells.
 * @docs-private
 */
export class StickyStyler {
  ...
  updateStickyColumns(
    ...
    const cellWidths: number[] = this._getCellWidths(
      firstRow,
