...
import { coerceElement } from './../../coercion/element';
import { normalizePassiveListenerOptions } from './../../platform/features/passive-listeners';
...
export class FocusMonitor implements OnDestroy {
  ...
  monitor(
    ...
    let focusListener = (event: FocusEvent) =>
      this._onFocus(event, nativeElement);
    let blurListener = (event: FocusEvent) =>
      this._onBlur(event, nativeElement);
